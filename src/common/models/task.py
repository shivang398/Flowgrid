...
class Task:
    id: str
    # Legacy Python function support
    ...
    def __post_init__(self):
        ...
        if self.idempotency_key is None:
            # Generate key based on either function or docker image/command
            seed = self.function_name or f"{self.image}:{self.command}"
            self.idempotency_key = generate_idempotency_key(seed, *self.args, **self.kwargs)
